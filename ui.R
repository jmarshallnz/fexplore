...
#  mainPanel(
  ...
  fluidRow(
      column(4,
        h3("Total variance in data"),
        plotOutput("dataPlot"),
        p("The total variance in the data is found by finding the sum of the square distances (blue lines) between the data and the mean under the null model, where we have only an intercept (the dashed line)"),
